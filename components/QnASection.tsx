...
export default function QnASection({
  ...
  return (
    <div className="space-y-4">
      {/* 메타 정보 */}
      <div className="flex flex-wrap gap-4 text-sm text-slate-300 p-3 bg-purple-500/10 rounded-lg border border-purple-400/30">
        ...
        {filteredQna.map((item) => (
          ...
          >
            ...
            <div className="mb-3">
              ...
              <p className="text-white pl-4 border-l-2 border-blue-400">
      ...
      {hasReport && onSwitchToEvaluation && (
        <div className="mt-6 p-4 bg-blue-500/10 rounded-lg border border-blue-400/30">
          <p className="text-blue-300 mb-3 text-sm font-medium">평가표 작성이 완료되었습니다</p>
          <button
