  ...
  return (
    <div className="glass-card p-12 flex flex-col items-center justify-center">
      <div className="relative">
        <div className="w-16 h-16 rounded-full border-4 border-brand-deep/20"></div>
      ...
      <div className="mt-6 flex gap-1">
        <div className="w-2 h-2 rounded-full bg-brand-deep animate-bounce" style={{ animationDelay: '0ms' }}></div>
        <div className="w-2 h-2 rounded-full bg-brand-deep animate-bounce" style={{ animationDelay: '150ms' }}></div>
        <div className="w-2 h-2 rounded-full bg-brand-deep animate-bounce" style={{ animationDelay: '300ms' }}></div>
      </div>
    </div>
  );
}
